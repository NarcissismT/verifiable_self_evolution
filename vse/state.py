...
class PromotionStateMachine:
    def __init__(
        ...
        *,
        ...
        self.initial_champion_digest = initial_champion_digest
    ...
    def state(self) -> ExperimentState:
        ...
        for entry in self.ledger.validate():
            ...
            if entry.event_type == "promotion_decision":
                ...
                if bool(entry.payload["promoted"]):
                    champion = str(entry.payload["candidate_checkpoint_digest"])
        ...
        return ExperimentState(
            ...
            champion_checkpoint_digest=champion,
    ...
    def record_promotion(
        ...
        if decision.champion_checkpoint_digest != current.champion_checkpoint_digest:
        ...
        self.ledger.append(
            "promotion_decision",
            {
                ...
                "candidate_checkpoint_digest": decision.candidate_checkpoint_digest,
                "champion_checkpoint_digest": decision.champion_checkpoint_digest,
    ...
    def record_final(self, decision: PromotionDecision) -> ExperimentState:
        ...
        if decision.candidate_checkpoint_digest != current.champion_checkpoint_digest:
        ...
        self.ledger.append(
            "final_decision",
            {
                "promoted": decision.promoted,
                "candidate_checkpoint_digest": decision.candidate_checkpoint_digest,
                "reference_checkpoint_digest": decision.champion_checkpoint_digest,
                "decision_digest": decision.decision_digest,
